...
import { FaBirthdayCake, FaEnvelopeOpen } from 'react-icons/fa';
      ...
      <Flex justify="center">
        ...
        >
          ...
          <Box maxW="800px" textAlign="center" mb="8">
            <Text fontSize="lg">
              I am Arindam Biswas, currently a Computer Science Engineering
              student at Brainware University. Interested in Web Application
              development.
            </Text>
          </Box>
          <Flex
